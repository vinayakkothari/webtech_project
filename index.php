    ...
    <section style="background-color: #fff2f1; height: 300px; padding-top: 70px;">
        <div class="container d-flex justify-content-center align-content-center">
            <div>
                ...
                <input id="newsletter_input" class="form-control" type="email" placeholder="Your Email" />
                <button class="btn btn-success mt-2" onclick="alert('Thank you for subscribing to our newsletter.');newsletter_input.value='';">Submit</button>
            </div>
        </div>
    </section>
</main>
...
<footer>
    <p class="text-center pt-3">&copy; Copyright 2024 Smart Shopping</p>
</footer>
